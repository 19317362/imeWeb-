...
pageHomeDoc.homeDocInit = function () {
    ...
    function g_callback() {
        ...
        homeDoc_bodyCh.click(function (e) {
            document.getElementById('homeDoc_allChecked').checked = checkAll(document.getElementsByClassName('homeDoc_bodyCh'), 'checked',"allChecked");
        });
        /*全选*/
        homeDoc_allChecked.click(function (e) {
            allcheckedFn($('.homeDoc_bodyCh'), this);
        });
        /*保存按钮点击事件*/
        ...
        function child_addDocInt() {
            ...
            modal_allchecked.click(function (e) {
                allcheckedFn($('.modal_bodyCh'), this);
            });
            ...
            homeDoc_search.click(function (e) {
                ...
                function searchDocInit() {
                    $('.modal_bodyCh').click(function () {
                        document.getElementById('modal_allChecked').checked = checkAll(document.getElementsByClassName('modal_bodyCh'), 'checked',"allChecked");
                    })
                }
            });
            /*查找用户模态框控制按钮点击事件*/
