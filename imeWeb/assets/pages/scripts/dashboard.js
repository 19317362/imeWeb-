    ...
    return {
        ...
        initEasyPieCharts: function() {
            ...
            $('.easy-pie-chart-reload').click(function() {
                ...
                $.get("/imeWeb/Services/workflow/queryMyTasksNumber",{}, function (data, textStatus){
                    baseTaskNumber =  parseInt(data.allwork);
                    emergencyTaskNumber = parseInt(data.jjwork);
                    activeTaskNumber = parseInt(data.cjwork);
                    overdueTaskNumber = parseInt(data.deadwork);
